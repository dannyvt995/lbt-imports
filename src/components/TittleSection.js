...
import ButtonHoverSplit from "./ButtonHoverSplit";
                ...
                <div className="content_more">
                    {pathName === '/natural-stone' ? (
                        <>
                            ...
                            <div className="btn">
                                <ButtonHoverSplit classAdd="width-full" typeEffect='textEffect1'>Gallery</ButtonHoverSplit>
                            </div>
                        </>
                        ...
                        <>
                            ...
                            <div className="btn">
                                <ButtonHoverSplit classAdd="width-full" typeEffect='textEffect1'>Natural Stone</ButtonHoverSplit>
                            </div>
                        </>
