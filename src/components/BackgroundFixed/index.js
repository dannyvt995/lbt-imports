...
export default function BackgroundFixed() {
    return(
        <div className="background_fixed_component" id="BACKGROUND_FIXED">
              <div className="for_banner_projects_page" id="BannerProjectPage"></div>
            ...
            <div className="for_banner_natural_stone"  id="BannerNaturalStone"></div>
